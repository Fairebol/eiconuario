...
<div class="flex flex-col justify-center font-bold w-full h-full text-center items-center align-middle relative select-none">
    <div class="flex justify-center items-center w-full h-screen">
        <img src="https://upload.wikimedia.org/wikipedia/commons/0/0b/Iberoconf_2013_-_Foto_grupal.jpg" class="w-2/3 flex justify-center">
    </div>
